...
if( isset($_POST['username'])){
  ...
  $sql = "update orders set status='Cooked',cookedby='".$username."' where id='".$order_id."'";
  $result = mysqli_query($dbhandle,$sql);
  if($result){
    echo "<script>alert('Order Set as Cooked successfully')</script>";
